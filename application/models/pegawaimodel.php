<?php
class PegawaiModel extends AfiModel
{
    protected $table_name = 'tb_pegawai';
    ...
    */
    ...
    function savenew(){
        ...
        $pegawai = array($id,$nama,$golongan,$alamat,$agama);
        $this->save($pegawai);
    }
    ...
    function saveedit() {
        ...
        $this->id = $id;
        $pegawai = array('id'=>$id,'nama'=>$nama,'golongan'=>$golongan,'alamat'=>$alamat,'agama'=>$agama);
        $this->save($pegawai);
    }
